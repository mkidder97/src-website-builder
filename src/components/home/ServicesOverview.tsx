...
import { FileSearch, ClipboardList, Calendar, CloudLightning, Calculator, ArrowRight } from "lucide-react";
          ...
          {services.map((service, index) => (
            ...
            >
              <Link
                ...
                className="group block h-full p-8 bg-card border border-border rounded-xl card-hover"
              >
